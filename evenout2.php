    ...
    <body>
        ...
        <!-- <nav>
            <ul id="menu"> 
                ...
                <li> <a href="creer.html"> <h2>Créer</h2> </a> 
                
                    <ul>
                        <li><a href="#"> Evènement unique</a></li>
                       <li> <a href="#">Selection d'évènements</a></li>
                ...
                <li> <a href="en_tête_de_page.html"> <h2> Mon compte</h2> </a> 
                    <ul>
                       <li> <a href="#"> Mon profit </a></li>
